...
#
# Generated by Vivado on Thu Mar 21 10:17:20 KST 2019
# SW Build 2258646 on Thu Jun 14 20:02:38 MDT 2018
#
# Copyright 1986-2018 Xilinx, Inc. All Rights Reserved. 
#
# usage: i2c_mpu6050.sh [-help]
# usage: i2c_mpu6050.sh [-lib_map_path]
# usage: i2c_mpu6050.sh [-noclean_files]
# usage: i2c_mpu6050.sh [-reset_run]
#
...
# executing this script. Please type 'i2c_mpu6050.sh -help' for more information.
#
...
# Script info
echo -e "i2c_mpu6050.sh - Script generated by export_simulation (Vivado v2018.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../mpu6050_hw.srcs/sources_1/bd/i2c_mpu6050/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../mpu6050_hw.srcs/sources_1/bd/i2c_mpu6050/ipshared/5bb9/hdl/verilog" +incdir+"$ref_dir/../../../../mpu6050_hw.srcs/sources_1/bd/i2c_mpu6050/ipshared/70fd/hdl" +incdir+"/media/kiott01a/SAMSUNG/Xilinx/Vivado/2018.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../mpu6050_hw.srcs/sources_1/bd/i2c_mpu6050/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work smartconnect_v1_0 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../mpu6050_hw.srcs/sources_1/bd/i2c_mpu6050/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../mpu6050_hw.srcs/sources_1/bd/i2c_mpu6050/ipshared/5bb9/hdl/verilog" +incdir+"$ref_dir/../../../../mpu6050_hw.srcs/sources_1/bd/i2c_mpu6050/ipshared/70fd/hdl" +incdir+"/media/kiott01a/SAMSUNG/Xilinx/Vivado/2018.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../mpu6050_hw.srcs/sources_1/bd/i2c_mpu6050/ipshared/5bb9/hdl/sc_util_v1_0_vl_rfs.sv" \
  2>&1 | tee -a vlogan.log

  vlogan -work axi_protocol_checker_v2_0_3 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../mpu6050_hw.srcs/sources_1/bd/i2c_mpu6050/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../mpu6050_hw.srcs/sources_1/bd/i2c_mpu6050/ipshared/5bb9/hdl/verilog" +incdir+"$ref_dir/../../../../mpu6050_hw.srcs/sources_1/bd/i2c_mpu6050/ipshared/70fd/hdl" +incdir+"/media/kiott01a/SAMSUNG/Xilinx/Vivado/2018.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../mpu6050_hw.srcs/sources_1/bd/i2c_mpu6050/ipshared/03a9/hdl/axi_protocol_checker_v2_0_vl_rfs.sv" \
  2>&1 | tee -a vlogan.log

  vlogan -work axi_vip_v1_1_3 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../mpu6050_hw.srcs/sources_1/bd/i2c_mpu6050/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../mpu6050_hw.srcs/sources_1/bd/i2c_mpu6050/ipshared/5bb9/hdl/verilog" +incdir+"$ref_dir/../../../../mpu6050_hw.srcs/sources_1/bd/i2c_mpu6050/ipshared/70fd/hdl" +incdir+"/media/kiott01a/SAMSUNG/Xilinx/Vivado/2018.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../mpu6050_hw.srcs/sources_1/bd/i2c_mpu6050/ipshared/b9a8/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a vlogan.log

  vlogan -work processing_system7_vip_v1_0_5 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../mpu6050_hw.srcs/sources_1/bd/i2c_mpu6050/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../mpu6050_hw.srcs/sources_1/bd/i2c_mpu6050/ipshared/5bb9/hdl/verilog" +incdir+"$ref_dir/../../../../mpu6050_hw.srcs/sources_1/bd/i2c_mpu6050/ipshared/70fd/hdl" +incdir+"/media/kiott01a/SAMSUNG/Xilinx/Vivado/2018.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../mpu6050_hw.srcs/sources_1/bd/i2c_mpu6050/ipshared/70fd/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a vlogan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../mpu6050_hw.srcs/sources_1/bd/i2c_mpu6050/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../mpu6050_hw.srcs/sources_1/bd/i2c_mpu6050/ipshared/5bb9/hdl/verilog" +incdir+"$ref_dir/../../../../mpu6050_hw.srcs/sources_1/bd/i2c_mpu6050/ipshared/70fd/hdl" +incdir+"/media/kiott01a/SAMSUNG/Xilinx/Vivado/2018.2/data/xilinx_vip/include" \
    "$ref_dir/../../../bd/i2c_mpu6050/ip/i2c_mpu6050_processing_system7_0_0/sim/i2c_mpu6050_processing_system7_0_0.v" \
    "$ref_dir/../../../bd/i2c_mpu6050/sim/i2c_mpu6050.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.i2c_mpu6050 xil_defaultlib.glbl -o i2c_mpu6050_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./i2c_mpu6050_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./i2c_mpu6050.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key i2c_mpu6050_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc i2c_mpu6050_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./i2c_mpu6050.sh -help\" for more information)\n"
    exit 1
  fi
