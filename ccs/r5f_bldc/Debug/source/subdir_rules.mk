...
source/%.obj: ../source/%.c $(GEN_OPTS) | $(GEN_FILES)
	...
	"/home/kiott01a/ti/ccsv8/tools/compiler/ti-cgt-arm_18.1.3.LTS/bin/armcl" -mv7R5 --code_state=32 --float_support=VFPv3D16 --include_path="/home/kiott01a/kiotta/ccs/r5f_bldc" --include_path="/home/kiott01a/ti/ccsv8/tools/compiler/ti-cgt-arm_18.1.3.LTS/include" --include_path="/home/kiott01a/kiotta/ccs/r5f_bldc/include" -g --diag_warning=225 --diag_wrap=off --display_error_number --enum_type=packed --abi=eabi --preproc_with_compile --preproc_dependency="source/$(basename $(<F)).d_raw" --obj_directory="source" $(GEN_OPTS__FLAG) "$(shell echo $<)"
